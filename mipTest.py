...
WEIGHTS2 = [40.0, 100.0/3.0, 200.0/7.0, 200.0/7.0, 25.0, 25.0, 200.0/9.0,
...
WEIGHTS = [200.0/2.0, 200.0/3.0, 200.0/4.0, 200.0/4.0, 200.0/5.0, 200.0/5.0, 200.0/6.0,
  ...
  for i in range(num_students):
    for j in range(num_courses):
      if x[i, j].solution_value() > 0:
        ...
        totalCourseVal = totalCourseVal + (courseValue[i][j]*SENIORITY[class_by_student[student_index[i]]])
